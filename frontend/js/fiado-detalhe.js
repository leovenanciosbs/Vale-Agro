...
async function carregarDetalheCliente() {
    ...
    const resposta = await fetch(`http://localhost:3000/fiados/${encodeURIComponent(clienteSelecionado)}`);
...
async function registrarPagamentoItensFiadoUnificado() {
    ...
    try {
        const resposta = await fetch('http://localhost:3000/fiados/pagamento-itens', {
            method: 'POST',
...
async function registrarPagamentoGeralFiadoUnificado() {
    ...
    try {
        const resposta = await fetch('http://localhost:3000/fiados/pagamento', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                cliente_nome: clienteSelecionado,
