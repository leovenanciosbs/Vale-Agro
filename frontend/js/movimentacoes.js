...
async function salvarMovimentacao() {
    ...
    const resposta = await fetch('/movimentacoes-estoque', {
        method: 'POST',
        headers: {
...
async function carregarMovimentacoes() {
    ...
    const resposta = await fetch(`/movimentacoes-estoque?${params.toString()}`);
    const dados = await resposta.json();
...
async function cancelarMovimentacao(id) {
    ...
    try {
        const resposta = await fetch(`/movimentacoes-estoque/${id}/cancelar`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
